...
public class VideoPlayerRecyclerView extends RecyclerView {
    ...
    public VideoPlayerRecyclerView(@NonNull Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }
...
//        String mediaUrl = mediaObjects.get(targetPosition).getPreviewVideoUrl();
//        String mediaUrl = "https://gounlimited.to/hllq08kx9xqo/Duaemrau.mp4";
//        String mediaUrl = "http://tc.members-access.com/nhp/episode/3241_0750.mp4";
        String mediaUrl = "https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/BigBuckBunny.mp4";
        if (mediaUrl != null) {
